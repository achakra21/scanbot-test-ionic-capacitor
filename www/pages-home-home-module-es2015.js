...
/* harmony import */ var _services_images_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/images.service */ "lA0O");
...
const { Filesystem, Camera, } = _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"];
...
let HomePage = class HomePage {
    constructor(imageService, router, loadingController, toastController) {
    ...
    fileRead(filepath) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            Filesystem.readFile({
                ...
                const base64Response = yield fetch(`data:image/jpeg;base64,${result.data}`);
    ...
    readFileContent(blob) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.imageService.doPost(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["BASE_URL"] + uploadImage + API_KEY, formData, 'multipart', this.imageService.createHeaderValues()).then((result) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
    ...
    reload() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.imageService.doGet(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["BASE_URL"] + loadImage + API_KEY).then(result => {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic-native/http/ngx */ "XSEc");
...
let ImagesService = class ImagesService {
   ...
   * @param formData
   */
    doPost(url, formData, serializeType, headerMapValues) {
