...
module.exports = __webpack_require__(/*! /Users/abhijit.chakra/scanbot-test-task-abhijit-chakra/src/main.ts */"zUnb");
...
const BASE_URL = 'http://54.76.15.222:8090/api/';
/*
...
const routes = [
    ...
    { path: 'imagedetails', loadChildren: './pages/imagedetail/imagedetail.module#ImagedetailPageModule' }
];
...
var map = {
	"./pages/imagedetail/imagedetail.module": [
		"JXRp",
		"pages-imagedetail-imagedetail-module"
	]
};
